...
def aude_pseudo
	puts "#{journalist_list.grep(/aude/).count + journalist_list.grep(/Aude/).count} ont un pseudo qui commence par aude"
end
aude_pseudo
...
underscore_inside(journalist_list)
